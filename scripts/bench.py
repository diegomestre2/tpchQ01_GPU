...
options = [
	"--hash-table-placement=local_mem",
	"--hash-table-placement=in_registers",
	"--hash-table-placement=in_registers_per_thread",
	"--hash-table-placement=global",
	"--hash-table-placement=shared_mem_per_thread",
	"--hash-table-placement=local_mem --apply-compression",
	"--hash-table-placement=in_registers --apply-compression",
	"--hash-table-placement=in_registers_per_thread --apply-compression",
	"--hash-table-placement=global --apply-compression",
	"--hash-table-placement=shared_mem_per_thread --apply-compression",
	"--hash-table-placement=local_mem --apply-compression --use-coprocessing",
	"--hash-table-placement=in_registers --apply-compression --use-coprocessing",
	"--hash-table-placement=in_registers_per_thread --apply-compression --use-coprocessing",
	"--hash-table-placement=global --apply-compression --use-coprocessing",
	"--hash-table-placement=shared_mem_per_thread --apply-compression --use-coprocessing",
	"--hash-table-placement=local_mem --apply-compression --use-filter-pushdown",
	"--hash-table-placement=in_registers --apply-compression --use-filter-pushdown",
	"--hash-table-placement=in_registers_per_thread --apply-compression --use-filter-pushdown",
	"--hash-table-placement=global --apply-compression --use-filter-pushdown",
	"--hash-table-placement=shared_mem_per_thread --apply-compression --use-filter-pushdown",
]
